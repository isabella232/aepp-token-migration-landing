      ...
      <article id="content">
        <app-hero :class="cta ? 'out-of-view' : 'in-view'">
          <template slot="text">
            ...
            <p>
              <strong class="ae-brand">Phase 0 ends <time>25th november 23:59 UTC</time></strong>
            </p>
          ...
          <app-faq>
            ...
            <template slot="questions">
              <app-accordion>
                ...
                <template slot="body">
                  <p>
                    Apart from Phase 0, all consecutive phases (the current phase included) will require a hard fork in order for migrated AE tokens to become available on the Mainnet. All hard forks are subject to the willingness of miners and users to update their node software in order to follow the updated rules of the æternity network. The æternity Establishment and Foundation will support the forks, but it is up to the miner and user communities to determine if a fork will be successful or not.
                    In addition to recently migrated AE tokens, the scheduled hard forks will also include protocol improvements which introduce new functionalities, features and optimizations.
